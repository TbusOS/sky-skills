...
- [**anthropic 图表画廊**](./demos/anthropic-design/diagrams.html) —— 51 幅手工 SVG 图（寄存器、SoC 框图、时序波形、调度时间线、互连与地址空间映射、物理数据通路、多地址空间对照、四张带方向的流动线动图……）
