# sage-design · canonical library

> 10 canonical page-types rendered at their **best** in the sage-design
...
| Blog index | `blog-index.html` + `blog-index.md` | ✅ v1 · 2026-05-02 |
| Product detail | `product-detail.html` + `product-detail.md` | — |
| Team | `team.html` + `team.md` | ✅ v1 · 2026-06-13 |
| Comparison | `comparison.html` + `comparison.md` | ✅ v1 · 2026-04-28 |
| FAQ | `faq.html` + `faq.md` | ✅ v1 · 2026-06-13 |
| Changelog | `changelog.html` + `changelog.md` | ✅ v1 · 2026-06-13 |
...
- Colour rules (when to use sage accent; when not)
- Don'ts
...
- **Don't** copy canonicals from another style (e.g., don't use
  ...
  sage-pricing page). The whole point of per-style canonicals is to
...
3. `bin/design-review skills/sage-design/references/canonical/<name>.html` → 0 errors.
