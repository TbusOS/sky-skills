# anthropic-design · canonical library

> 10 canonical page-types rendered at their **best** in the anthropic-design
...
- Colour rules (when to use orange accent; when not)
- Don'ts
...
- **Don't** copy canonicals from another style (e.g., don't use
  ...
  anthropic-pricing page). The whole point of per-style canonicals is to
...
3. `bin/design-review skills/anthropic-design/references/canonical/<name>.html` → 0 errors.
