# apple-design · canonical library

> 10 canonical page-types rendered at their **best** in the apple-design
...
- Colour rules (when to use blue accent; when not)
- Don'ts
...
3. `bin/design-review skills/apple-design/references/canonical/<name>.html` → 0 errors.
