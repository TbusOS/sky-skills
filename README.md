...
- [**anthropic diagram gallery**](./demos/anthropic-design/diagrams.html) — 43 hand-crafted SVG diagrams (registers, SoC blocks, waveforms, schedulers, physical data paths …)
...
- **Diagrams** — 33 SVG templates with orange/blue/green category coloring and diamond decision gates, including kernel-grade types (register-bitfield / soc-block / hw-timing-waveform / sched-timeline / protocol-stack / address-map / soc-dataflow / gpu-dataflow / vram-dataflow) plus a `glyphs.svg` component sheet — browse them all in the [43-figure gallery](demos/anthropic-design/diagrams.html)
