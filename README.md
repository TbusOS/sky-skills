...
Five design skills ship with single-page flagship demos under [`demos/`](./demos/) — same content, five aesthetics:
...
- [**glass diagram gallery**](./demos/glass-design/diagrams.html) — 7 of the same diagram types as frosted panels on the aurora field (theme-proof SVG ink)
...
| [design-planner](skills/design-planner/) | ZH | **Brief→sprint-contract planner** for the 5 design skills — expands a vague one-line brief into page-type + audience + section plan + hard quotas (diagram density / bilingual / brand) before any HTML is written, wrapping `bin/design-review --plan`. Unknown page-types borrow the nearest canonical structure and are stamped LOW-CONFIDENCE |
