...
- [**anthropic diagram gallery**](./demos/anthropic-design/diagrams.html) — 42 hand-crafted SVG diagrams (registers, SoC blocks, waveforms, schedulers, physical data paths …)
- [**anthropic hardware data path**](./demos/anthropic-design/hardware.html) — two figures on how pixel data physically moves: the display path with no GPU, and where the data actually goes once a GPU is added
...
- **Diagrams** — 32 SVG templates with orange/blue/green category coloring and diamond decision gates, including kernel-grade types (register-bitfield / soc-block / hw-timing-waveform / sched-timeline / protocol-stack / address-map / soc-dataflow / gpu-dataflow) plus a `glyphs.svg` component sheet — browse them all in the [42-figure gallery](demos/anthropic-design/diagrams.html)
