...
- [**anthropic diagram gallery**](./demos/anthropic-design/diagrams.html) — 77 hand-crafted SVG diagrams (registers, SoC blocks, waveforms, schedulers, physical data paths, address spaces, cross-sections, exploded views, pinouts, log-scale rulers, four animated …)
