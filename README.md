...
- [**anthropic diagram gallery**](./demos/anthropic-design/diagrams.html) — 48 hand-crafted SVG diagrams (registers, SoC blocks, waveforms, schedulers, physical data paths, address spaces, one animated …)
...
- **Diagrams** — 37 SVG templates with orange/blue/green category coloring and diamond decision gates, including kernel-grade types (register-bitfield / soc-block / hw-timing-waveform / sched-timeline / protocol-stack / address-map / soc-dataflow / gpu-dataflow / vram-dataflow / platform-block / address-spaces / copy-vs-share / dataflow-animated) plus **two** component sheets (`glyphs.svg`, `glyphs-memory.svg`) — browse them all in the [48-figure gallery](demos/anthropic-design/diagrams.html)
