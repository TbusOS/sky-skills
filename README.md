...
- [**anthropic diagram gallery**](./demos/anthropic-design/diagrams.html) — 51 hand-crafted SVG diagrams (registers, SoC blocks, waveforms, schedulers, physical data paths, address spaces, four animated …)
